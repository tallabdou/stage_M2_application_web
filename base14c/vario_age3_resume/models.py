...
class Vario_Age3_Resume(models.Model):
    ...
    graphitisation_date = models.DateTimeField(null=True, blank=True)
    comment = models.CharField(max_length=200, null=True, blank=True)
    age_nr = models.CharField(max_length=200, null=True, blank=True)
